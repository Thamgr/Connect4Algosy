import math
import random
from enviroment.heuristics import eval_lines
from .base import Strategy

WIN = 100000
INF = 10 ** 9
BRANCHING = 3
BASE_TIME = 1e-3  # tuned so fit_depth(1.0)=7 (~1.16s on the empirical bench); eval_lines leaf is ~5x slower than zero-leaf αβ


class BruteForceEval(Strategy):
    name = "brute_force_eval"
